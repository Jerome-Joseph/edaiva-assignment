...
router.post('/createuser',[
    body('fname','First Name should be more than 3 characters').isLength({ min: 3 }),
    body('lname','Last Name should be more than 3 characters').isLength({ min: 3 }),
    body('email',"Enter a valid email").isEmail(),
    body('phone','Number should be 10 digits').isLength({ min: 10 }),
    body('address','Address should be more than 5 characters').isLength({ min: 5 }),
